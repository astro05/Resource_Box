                                ...
                                <div class="collapse" id="accordion-tab-5-content-2" aria-labelledby="accordion-tab-5-heading-2" data-parent="#accordion-tab-5">
                                    <div class="card-body">
                                        <p>Our location and mobile no are given on contact page. 143/2,Moghbazar Dhaka</p>
                                         <p><strong>Map Location: </strong><a href="https://goo.gl/maps/wWjrsBnjJyDtJdaL6">Google Map</a></p>
...
React.render(
    <Intro />, document.getElementById("testdiv"));
...
React.render(
<Intro />, document.getElementById("reactdiv"));*/